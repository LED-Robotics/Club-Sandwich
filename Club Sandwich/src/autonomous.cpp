...
void executeAutonomous() {
    //Insert LED Programming here or inside the individual autonomous function calls (this file).
    // if (alliance == BLUE_ID) {
    //     useLEDS(pros::COLOR_BLUE, pros::COLOR_BLUE);
    // } else if (alliance == RED_ID) {
    //     useLEDS(pros::COLOR_RED, pros::COLOR_RED);
    // }
